                ...
                {/* <div className={styles.inner_carousal_data_outer}>
                  <div>
                    ...
                    <div className={styles.inner_carousal_paragraph_flex}>
                      ...
                      <div className={styles.inner_carousal_paragraph2}>
                        Made from all composed full sheet veneers in all layers,
                        ensuring a robust and well-structured plywood.
                      </div>
                    </div>
                  </div>
                </div> */}
                ...
                {/* <div className={styles.inner_carousal_data_outer}>
                  <div>
                    ...
                    <div className={styles.inner_carousal_paragraph_flex}>
                      ...
                      <div className={styles.inner_carousal_paragraph2}>
                        The veneers are sourced from select hardwood species to
                        ensure the plywood's stability and stand in the boiling
                        water testing.
                      </div>
                    </div>
                  </div>
                ...
                {/* <div className={styles.inner_carousal_data_outer}>
                  <div>
                    ...
                    <div className={styles.inner_carousal_paragraph_flex}>
                      ...
                      <div className={styles.inner_carousal_paragraph2}>
                        This maintains the ideal moisture balance, preventing
