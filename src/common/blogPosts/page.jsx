            ...
            {displayedData.map((item, index) => (
                <div key={index} className={styles.BlogPost_outer}>
                    <div className={styles.BlogPost_imageOuter}>
                        <Image src={item.image} className={styles.BlogPost_image} alt='image_blog' />
                    </div>
                    ...
                    <button onClick={() => handleReadMoreClick(item.readMoreRoute)} className={styles.button9} role="button">
